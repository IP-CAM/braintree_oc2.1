...
class ControllerPaymentBraintreeTlt extends Controller {
	public function index() {
		$this->language->load('payment/braintree_tlt');
		...
		if (file_exists(DIR_SYSTEM . '/braintree/lib/Braintree.php')) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/braintree_tlt.tpl')) {
				return $this->load->view($this->config->get('config_template') . '/template/payment/braintree_tlt.tpl', $data);
			} else {
				return $this->load->view('default/template/payment/braintree_tlt.tpl', $data);
			}
		}
		...
		$this->load->model('payment/braintree_tlt');
